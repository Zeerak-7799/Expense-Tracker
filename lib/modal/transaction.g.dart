...
extension TransactionQueryFilter
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> moneyEqualTo(
    double value, {
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> moneyLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> moneyBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByCreatedOnDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.desc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByMoney() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'money', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByMoneyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByCreatedOnDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.desc);
    });
  }
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByMoney() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'money', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByMoneyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'money', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdOn');
    });
  }

  QueryBuilder<Transaction, Transaction, QDistinct> distinctByMoney() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, DateTime?, QQueryOperations> createdOnProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdOn');
    });
  }

  QueryBuilder<Transaction, double, QQueryOperations> moneyProperty() {
    return QueryBuilder.apply(this, (query) {
